...
git clone https://github.com/357up/Slack-Bolt-Python-App-Template.git

# Change into this project directory
cd Slack-Bolt-Python-App-Template
...
`MyApp/*` is a directory containing all the logic for your application.
